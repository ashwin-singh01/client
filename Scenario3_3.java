...
public class Scenario3_3 {
	Response res ;
	
	@Given("Incorrect or incomplete API for Latest Foreign Exchange Rates base")
	public void incorrect_or_incomplete_api_for_latest_foreign_exchange_rates_base() {
	...
	public void the_incomplete_api_is_given() {
	    // Write code here that turns the phrase above into concrete actions
	...
	public void assert_the_status_response() {
